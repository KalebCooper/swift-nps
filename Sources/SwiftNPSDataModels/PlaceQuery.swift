/// Filters and pagination settings for the NPS places endpoint.
///
...
/// let endpoint = Endpoint.places(query: query)
/// ```
public struct PlaceQuery: NPSCollectionQuery {
  ...
  /// Each page decodes as a collection of ``Place`` values.
  public typealias Item = Place

  /// The places collection path.
  public static let path = "/places"
  ...
  /// The places parameters for this page, omitting empty code arrays.
