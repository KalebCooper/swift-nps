/// Filters, sorting, and pagination settings for the NPS photo galleries endpoint.
///
...
///   parkCodes: [ParkCode("thrb")], sort: [.ascending("title")])
/// let endpoint = Endpoint.photoGalleries(query: query)
/// ```
public struct PhotoGalleryQuery: NPSCollectionQuery {
  ...
  /// Each page decodes as a collection of ``PhotoGallery`` values.
  public typealias Item = PhotoGallery

  /// The photo galleries collection path.
  public static let path = "/multimedia/galleries"
  ...
  ///   - sort: Ordered criteria naming photo gallery properties, such as `title`.
  ...
  /// The photo gallery parameters for this page, omitting empty code and sort arrays.
