/// Filters, sorting, and pagination settings for the NPS park videos endpoint.
///
...
///   parkCodes: [ParkCode("crmo")], sort: [.ascending("title")])
/// let endpoint = Endpoint.parkVideos(query: query)
/// ```
public struct ParkVideoQuery: NPSCollectionQuery {
  ...
  /// Each page decodes as a collection of ``ParkVideo`` values.
  public typealias Item = ParkVideo

  /// The park videos collection path.
  public static let path = "/multimedia/videos"
  ...
  ///   - sort: Ordered criteria naming park video properties, such as `title`.
  ...
  /// The park video parameters for this page, omitting empty code and sort arrays.
