/// Filters, sorting, and pagination settings for the NPS park audio endpoint.
///
...
///   parkCodes: [ParkCode("choh")], sort: [.ascending("title")])
/// let endpoint = Endpoint.parkAudio(query: query)
/// ```
public struct ParkAudioQuery: NPSCollectionQuery {
  ...
  /// Each page decodes as a collection of ``ParkAudio`` values.
  public typealias Item = ParkAudio

  /// The park audio collection path.
  public static let path = "/multimedia/audio"
  ...
  ///   - sort: Ordered criteria naming park audio properties, such as `title`.
  ...
  /// The park audio parameters for this page, omitting empty code and sort arrays.
