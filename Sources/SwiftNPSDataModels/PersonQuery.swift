/// Filters and pagination settings for the NPS people endpoint.
///
...
/// let endpoint = Endpoint.people(query: query)
/// ```
public struct PersonQuery: NPSCollectionQuery {
  ...
  /// Each page decodes as a collection of ``Person`` values.
  public typealias Item = Person

  /// The people collection path.
  public static let path = "/people"
  ...
  /// The people parameters for this page, omitting empty code arrays.
