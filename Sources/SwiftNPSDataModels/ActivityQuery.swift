...
///
/// ```swift
/// let query = try ActivityQuery(parkCodes: [ParkCode("drto")], sort: [.descending("name")])
/// let endpoint = Endpoint.activities(query: query)
/// ```
public struct ActivityQuery: NPSCollectionQuery {
  ...
  /// Each page decodes as a collection of ``Activity`` values.
  public typealias Item = Activity
