/// Filters, sorting, and pagination settings for the NPS visitor centers endpoint.
///
...
/// let endpoint = Endpoint.visitorCenters(query: query)
/// ```
public struct VisitorCenterQuery: NPSCollectionQuery {
  ...
  /// Each page decodes as a collection of ``VisitorCenter`` values.
  public typealias Item = VisitorCenter

  /// The visitor centers collection path.
  public static let path = "/visitorcenters"
  ...
  ///
  /// NPS documents visitor center sorting by resource properties without listing them, so fields
  ...
  ///   - sort: Ordered criteria naming visitor center properties.
  ...
  /// The visitor centers parameters for this page, omitting empty code and sort arrays.
