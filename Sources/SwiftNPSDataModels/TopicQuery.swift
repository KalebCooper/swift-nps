...
///
/// ```swift
/// let query = try TopicQuery(parkCodes: [ParkCode("mamc")], sort: [.descending("name")])
/// let endpoint = Endpoint.topics(query: query)
/// ```
public struct TopicQuery: NPSCollectionQuery {
  ...
  /// Each page decodes as a collection of ``Topic`` values.
