...
///
/// Identity and name are the only fields the provider sends. Unlike ``TopicParks``, a page of
/// topics carries no nested parks; use ``TopicParks`` to see which parks relate to a topic.
/// Unknown JSON fields are ignored by Codable.
///
/// ```swift
/// let page = try JSONDecoder().decode(NPSCollection<Topic>.self, from: data)
