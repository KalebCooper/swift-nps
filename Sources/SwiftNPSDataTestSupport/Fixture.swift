...
package enum Fixture: String, CaseIterable, Sendable {
  ...
  /// GET /api/v1/topics?limit=1&parkCode=zzzz&start=0; HTTP 200 with no matches.
  /// Recorded September 22, 2026.
  case topicsEmpty = "topics-empty"

  /// GET /api/v1/topics?id=28AEAE85-9DDA-45B6-981B-1CFCDCC61E14,
  /// 7DA81DAB-5045-4953-9C20-36590AD9FA95&limit=1&parkCode=mamc&sort=-name&start=0; HTTP 200.
  /// Recorded September 22, 2026.
  case topicsPageFirst = "topics-page-first"

  /// GET /api/v1/topics?id=28AEAE85-9DDA-45B6-981B-1CFCDCC61E14,
  /// 7DA81DAB-5045-4953-9C20-36590AD9FA95&limit=1&parkCode=mamc&sort=-name&start=1; HTTP 200.
  /// Recorded September 22, 2026.
  case topicsPageLast = "topics-page-last"

  /// GET /api/v1/topics?limit=2&parkCode=acad,mamc&q=history&sort=-name&start=0; HTTP 200.
  /// Recorded September 22, 2026.
  case topicsSearch = "topics-search"
