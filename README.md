...
| People | Park codes, state codes, text search. | `personPages`, `people` | The endpoint answers a sort value with HTTP 400, so the query offers none; coordinates stay the provider's text, usually empty, and profiles stay HTML. |
